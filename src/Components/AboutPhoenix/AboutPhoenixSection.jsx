...
const AboutPhoenixSection = () => {
    ...
    return (
        ...
        >
            ...
            <div ref={targetRef} className="flex flex-wrap items-center justify-center w-full gap-y-10 md:justify-start lg:justify-between 3xl:justify-center 3xl:gap-24">
