...
const Journey = () => {
    ...
    const top = useTransform(scrollYProgress, windoWidth < 600 ? [0, 0.0001, 0.0002] : [0, 0.18, 0.20], windoWidth < 600 ? ['0px', '0px', '0px'] : ['200px', '200px', '0px'])
    const scaleText = useTransform(scrollYProgress, windoWidth < 600 ? [0, 0.0001, 0.0002] : [0, 0.18, 0.20], windoWidth < 600 ? ['1', '1', '1'] : ['0.7', '0.6', '1'])
